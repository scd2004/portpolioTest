        ...
        <article>
          <section id="pagemenu">
            <ul class="page_menu three clear">
              <li><a href="userInfo01.do">개인 정보 변경</a></li>
              <li><a href="userInfo02.do">비밀번호 변경</a></li>
              <li><a href="userInfo03.do">회원 탈퇴</a></li>
            </ul>
          </section>
          <section>
            <div>
            ...
            <div>
              <div>
                <form id="modifyForm" name="submitForm" method="post">
                  <fieldset>
                  	<input type="hidden" id="age_type" name="age_type" value="general">
					<input type="hidden" id="gubunDate" name="gubunDate" value="2005-08-27">
                    <div>
                      <div>아이디</div>
                      <div>
                        <input type="text" title="아이디" value= "${user.id }" readonly>
                      </div>
                    </div>
                    <div>
                      <div>닉네임</div>
                      <div>
                        <div>
                          <input type="text" title="닉네임 입력" maxlength="20" name="nick" id="nick" value="${user.nick }" placeholder="사용할 닉네임을 입력해 주세요">
                          <div>
                          	<select name="fixnic" id="fixnic" name="fixnic"> <!--onchange="nicktype_change();" -->
                    ...
                    <div>
                      <div>이름</div>
                      <div>
                        <input type="text" title="이름" id="name" name="name" value="${user.name }" readonly>
                      </div>
                    </div>
                    <div>
                      <div>가입 인증 이메일</div>
                      <div>
                        <input type="text" title="이메일"  value="${user.mail }" id="mail" readonly >
                        <span>@</span>
                        <input type="text" title="이메일 주소" value="${user.mail01 }" id="mail01" readonly>
                        <button type="button" id="email_changePop">인증 이메일 변경</button>
                      </div>
                    </div>
            ...
            <div>
              <div>
               <a href="update_userNick.do"><button type="button" id="modify_info">확인</button></a>
              </div>
            </div>
          </section>
